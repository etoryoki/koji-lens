    ...
    <section id="pricing" className="border-b border-slate-200">
      <div className="mx-auto max-w-6xl px-6 py-20">
        ...
        <p className="mb-4 text-center text-sm text-slate-500 md:hidden">
          Free <span className="font-medium text-slate-700">¥0</span> · Pro 月額 <span className="font-medium text-slate-700">$7</span> · Pro 年額 <span className="font-medium text-slate-700">$70</span>
        </p>
